...
public class DsnApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(DsnApplicationApp.class);

    private final Environment env;

    public DsnApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes DsnApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DsnApplicationApp.class);
